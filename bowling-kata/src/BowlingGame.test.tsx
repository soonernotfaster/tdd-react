...
describe(BowlingGame, () => {
  describe("initial render", () => {
    it("has 10 empty frames", async () => {
      ...
      for (let frame = 1; frame < 11; frame++) expectFrameScoreToBe(frame, "");
    });
  ...
  describe.each([
    ...
    "when each roll is $rollButton",
    ({ rollButton, rollScore, frameScore, totalScore }) => {
      beforeEach(() => {
        userEvent.setup();
